 ...
 */
final class Version20210516150630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP parent_id, CHANGE created_at created_at DATETIME NOT NULL');
